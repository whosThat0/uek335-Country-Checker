  ...
  return (
    <View style={styles.container}>
      ...
      <Card style={styles.card}>
        <Card.Content>
            <Text style={[styles.cardText, { fontFamily: 'Montserrat-Light' }]}>What is this</Text>
      ...
      <Text style={[styles.question, { fontFamily: 'Montserrat-Light' }]}>Want to see the countries?</Text>
      <Button
        mode="contained"
